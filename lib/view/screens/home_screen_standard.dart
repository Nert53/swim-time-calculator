...
class HomeScreenStandard extends StatefulWidget {
  const HomeScreenStandard({super.key});

  @override
  State<HomeScreenStandard> createState() => _HomeScreenStandardState();
}

class _HomeScreenStandardState extends State<HomeScreenStandard> {
  ...
  Color resultTimeColor = Colors.black;
  ...
  void updateResultTimeColor() {
    ...
    if (resultTime > originalTime) {
      resultTimeColor = Colors.red;
    }
    if (resultTime < originalTime) {
      resultTimeColor = Colors.green;
    }
    if (resultTime == originalTime) {
      resultTimeColor = Colors.black;
    }
  }
            ...
            child: Column(
              children: [
                ...
                TextField(
                  ...
                  readOnly: true,
                  style: TextStyle(
                      color: resultTimeColor, fontWeight: FontWeight.bold),
                          ...
                          children: [
                            HoldDownButton(
                              onHoldDown: () {
                                setState(() {
                                  final oldSR =
                                      double.parse(strokeRateController2.text);
                          ...
                          children: [
                            HoldDownButton(
                              onHoldDown: () {
                                setState(() {
                                  final oldSL =
                                      double.parse(strokeLengthController.text);
